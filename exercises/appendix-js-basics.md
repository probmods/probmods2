...
A) Write an array of even numbers between 0 and 10 inclusive. (You can either write this out manually, using the underscore `_.range()` function, or writing a recursive function. [Perhaps there are other ways too!])
