...
Test your knowledge: [Exercises]({{site.baseurl}}/exercises/04.5-agents-as-programs.html)

Reading & Discussion: [Readings]({{site.baseurl}}/readings/04.5-agents-as-programs.html)
