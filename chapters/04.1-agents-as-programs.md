...
description: "One-shot decision problems, softmax choice, and POMDP." 
is_section: true
---
...
var literalListener = function(utterance){
  Infer({model: function(){
    var meaning = meaningPrior();
    var uttTruthVal = meaning(utterance, meaning);
...
Make sure you understand why the pragmatic listener's ($$L_{1}$$'s) interpretation of "blue" differs so dramatically from the literal listener's.  
